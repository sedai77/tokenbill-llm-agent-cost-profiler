...
def claude_code() -> list[Any]:
    ...
    logs = [
        ...
        event("api_request", T0 + 5_000, model="claude-opus-5-5", request_id="req_a1",
              ...
              query_source="main", effort="high", attempt=1, stop_reason="tool_use", **user),
        ...
        event("api_error", T0 + 60_200, model="claude-opus-5-5", request_id="req_a2",
              ...
              error=f"Overloaded {CANARY}", query_source="main", **user),
        event("api_request", T0 + 64_000, model="claude-opus-5-5", request_id="req_a2",
              ...
              query_source="main", effort="high", attempt=2, stop_reason="end_turn", **user),
        event("api_request", T0 + 92_000, model="claude-sonnet-5", request_id="req_a3",
              ...
              query_source="subagent", attempt=1, **user),
    ...
    spans = [
        span("claude_code.llm_request", trace, "a1a1a1a1a1a1a1a1", None, T0 + 1_000, T0 + 5_000,
             ...
             query_source="main", input_tokens=12, output_tokens=800, cache_read_tokens=0,
             cache_creation_tokens=30_000, session__id="sess-a"),
        span("claude_code.llm_request", trace, "a3a3a3a3a3a3a3a3", None, T0 + 90_000,
             ...
             agent_id="agent-7", query_source="subagent", input_tokens=20, output_tokens=150,
             cache_read_tokens=0, cache_creation_tokens=9_000, session__id="sess-a"),
